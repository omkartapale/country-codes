            ...
            <div className="card-body">
                <div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6 col-xl-3 animate slide delay-2">
                    ...
                    <div className="col-md-6 col-xl-3 animate slide delay-3">
                    ...
                    <div className="col-md-6 col-xl-3 animate slide delay-4">
